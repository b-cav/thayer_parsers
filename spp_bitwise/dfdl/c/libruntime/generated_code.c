...
static void array_idle_df_spp_pkt_t_spp_pkt__parseSelf(spp_pkt_ *instance, PState *pstate);
static void array_idle_df_spp_pkt_t_spp_pkt__unparseSelf(const spp_pkt_ *instance, UState *ustate);
static size_t array_idle_df_spp_pkt_t_spp_pkt__getArraySize(const spp_pkt_ *instance);
static void array_octet_udf_t_other_df_spp_pkt_t__parseSelf(other_df_spp_pkt_t_ *instance, PState *pstate);
static void array_octet_udf_t_other_df_spp_pkt_t__unparseSelf(const other_df_spp_pkt_t_ *instance, UState *ustate);
static size_t array_octet_udf_t_other_df_spp_pkt_t__getArraySize(const other_df_spp_pkt_t_ *instance);
static void other_df_spp_pkt_t__parseSelf(other_df_spp_pkt_t_ *instance, PState *pstate);
static void other_df_spp_pkt_t__unparseSelf(const other_df_spp_pkt_t_ *instance, UState *ustate);
static void array_other_df_spp_pkt_t_spp_pkt__parseSelf(spp_pkt_ *instance, PState *pstate);
static void array_other_df_spp_pkt_t_spp_pkt__unparseSelf(const spp_pkt_ *instance, UState *ustate);
static size_t array_other_df_spp_pkt_t_spp_pkt__getArraySize(const spp_pkt_ *instance);
...
static const ERD idle_df_spp_pkt_t_ERD = {
    {
        NULL, // namedQName.prefix
...
static const spp_pkt_ array_idle_df_spp_pkt_t_spp_pkt__compute_offsets;

static const size_t array_idle_df_spp_pkt_t_spp_pkt__childrenOffsets[1] = {
    (const char *)&array_idle_df_spp_pkt_t_spp_pkt__compute_offsets.idle_df[1] - (const char *)&array_idle_df_spp_pkt_t_spp_pkt__compute_offsets.idle_df[0]
};

static const ERD *const array_idle_df_spp_pkt_t_spp_pkt__childrenERDs[1] = {
    &idle_df_spp_pkt_t_ERD
};

static const ERD array_idle_df_spp_pkt_t_spp_pkt_ERD = {
    {
        NULL, // namedQName.prefix
        "idle_df", // namedQName.local
        NULL, // namedQName.ns
    ...
    ARRAY, // typeCode
    1, // maxOccurs
    array_idle_df_spp_pkt_t_spp_pkt__childrenOffsets,
    array_idle_df_spp_pkt_t_spp_pkt__childrenERDs,
    (ERDParseSelf)&array_idle_df_spp_pkt_t_spp_pkt__parseSelf,
    (ERDUnparseSelf)&array_idle_df_spp_pkt_t_spp_pkt__unparseSelf,
    {.getArraySize = (GetArraySize)&array_idle_df_spp_pkt_t_spp_pkt__getArraySize}
};

static const ERD octet_udf_t_ERD = {
    {
        NULL, // namedQName.prefix
        "octet", // namedQName.local
        NULL, // namedQName.ns
...
static const other_df_spp_pkt_t_ array_octet_udf_t_other_df_spp_pkt_t__compute_offsets;

static const size_t array_octet_udf_t_other_df_spp_pkt_t__childrenOffsets[1] = {
    (const char *)&array_octet_udf_t_other_df_spp_pkt_t__compute_offsets.octet[1] - (const char *)&array_octet_udf_t_other_df_spp_pkt_t__compute_offsets.octet[0]
};

static const ERD *const array_octet_udf_t_other_df_spp_pkt_t__childrenERDs[1] = {
    &octet_udf_t_ERD
};

static const ERD array_octet_udf_t_other_df_spp_pkt_t_ERD = {
    {
        NULL, // namedQName.prefix
        "octet", // namedQName.local
        NULL, // namedQName.ns
    ...
    ARRAY, // typeCode
    65536, // maxOccurs
    array_octet_udf_t_other_df_spp_pkt_t__childrenOffsets,
    array_octet_udf_t_other_df_spp_pkt_t__childrenERDs,
    (ERDParseSelf)&array_octet_udf_t_other_df_spp_pkt_t__parseSelf,
    (ERDUnparseSelf)&array_octet_udf_t_other_df_spp_pkt_t__unparseSelf,
    {.getArraySize = (GetArraySize)&array_octet_udf_t_other_df_spp_pkt_t__getArraySize}
};

static const other_df_spp_pkt_t_ other_df_spp_pkt_t__compute_offsets;

static const size_t other_df_spp_pkt_t__childrenOffsets[1] = {
    (const char *)&other_df_spp_pkt_t__compute_offsets.octet[0] - (const char *)&other_df_spp_pkt_t__compute_offsets
};

static const ERD *const other_df_spp_pkt_t__childrenERDs[1] = {
    &array_octet_udf_t_other_df_spp_pkt_t_ERD
};

static const ERD other_df_spp_pkt_t_ERD = {
    {
        NULL, // namedQName.prefix
    ...
    COMPLEX, // typeCode
    1, // numChildren
    other_df_spp_pkt_t__childrenOffsets,
    other_df_spp_pkt_t__childrenERDs,
    (ERDParseSelf)&other_df_spp_pkt_t__parseSelf,
    (ERDUnparseSelf)&other_df_spp_pkt_t__unparseSelf,
    {.initChoice = NULL}
};

static const spp_pkt_ array_other_df_spp_pkt_t_spp_pkt__compute_offsets;

static const size_t array_other_df_spp_pkt_t_spp_pkt__childrenOffsets[1] = {
    (const char *)&array_other_df_spp_pkt_t_spp_pkt__compute_offsets.other_df[1] - (const char *)&array_other_df_spp_pkt_t_spp_pkt__compute_offsets.other_df[0]
};

static const ERD *const array_other_df_spp_pkt_t_spp_pkt__childrenERDs[1] = {
    &other_df_spp_pkt_t_ERD
};

static const ERD array_other_df_spp_pkt_t_spp_pkt_ERD = {
    {
        NULL, // namedQName.prefix
        "other_df", // namedQName.local
        NULL, // namedQName.ns
    ...
    ARRAY, // typeCode
    1, // maxOccurs
    array_other_df_spp_pkt_t_spp_pkt__childrenOffsets,
    array_other_df_spp_pkt_t_spp_pkt__childrenERDs,
    (ERDParseSelf)&array_other_df_spp_pkt_t_spp_pkt__parseSelf,
    (ERDUnparseSelf)&array_other_df_spp_pkt_t_spp_pkt__unparseSelf,
    {.getArraySize = (GetArraySize)&array_other_df_spp_pkt_t_spp_pkt__getArraySize}
};

static const spp_pkt_ spp_pkt__compute_offsets;

static const size_t spp_pkt__childrenOffsets[4] = {
    ...
    (const char *)&spp_pkt__compute_offsets.idle_df[0] - (const char *)&spp_pkt__compute_offsets,
    (const char *)&spp_pkt__compute_offsets.other_df[0] - (const char *)&spp_pkt__compute_offsets
};

static const ERD *const spp_pkt__childrenERDs[4] = {
    &prim_hdr_spp_pkt_t_ERD,
    &array_sec_hdr_spp_pkt_t_spp_pkt_ERD,
    &array_idle_df_spp_pkt_t_spp_pkt_ERD,
    &array_other_df_spp_pkt_t_spp_pkt_ERD
};
...
{
    UNUSED(instance);
    return ((spp_pkt_ *)instance->_base.parent)->prim_hdr.len;
}
...
{
    return instance->prim_hdr.shf;
}

static void
array_idle_df_spp_pkt_t_spp_pkt__initERD(spp_pkt_ *instance, InfosetBase *parent)
{
    UNUSED(parent);
    for (size_t i = 0; i < 1; i++)
    {
        instance->idle_df[i].array = instance->_a_idle_df[i];
        instance->idle_df[i].lengthInBytes = sizeof(instance->_a_idle_df[i]);
        instance->idle_df[i].dynamic = false;
    }
}

static void
array_idle_df_spp_pkt_t_spp_pkt__parseSelf(spp_pkt_ *instance, PState *pstate)
{
    const size_t arraySize = array_idle_df_spp_pkt_t_spp_pkt__getArraySize(instance);
    validate_array_bounds("array_idle_df_spp_pkt_t_spp_pkt_", arraySize, 0, 1, &pstate->pu);
    if (pstate->pu.error) return;

    for (size_t i = 0; i < arraySize; i++)
    {
        parse_hexBinary(&instance->idle_df[i], pstate);
        if (pstate->pu.error) return;
        uint8_t arrays_idle_df[][2] = {{0xAA, 0xAA}};
        HexBinary enums_idle_df[] = {{arrays_idle_df[0], 2, false}};
        validate_hexbinary_enumeration(&instance->idle_df[i], 1, enums_idle_df, "idle_df", &pstate->pu);
        if (pstate->pu.error) return;
    }
}

static void
array_idle_df_spp_pkt_t_spp_pkt__unparseSelf(const spp_pkt_ *instance, UState *ustate)
{
    const size_t arraySize = array_idle_df_spp_pkt_t_spp_pkt__getArraySize(instance);
    validate_array_bounds("array_idle_df_spp_pkt_t_spp_pkt_", arraySize, 0, 1, &ustate->pu);
    if (ustate->pu.error) return;

    for (size_t i = 0; i < arraySize; i++)
    {
        unparse_hexBinary(instance->idle_df[i], ustate);
        if (ustate->pu.error) return;
        uint8_t arrays_idle_df[][2] = {{0xAA, 0xAA}};
        HexBinary enums_idle_df[] = {{arrays_idle_df[0], 2, false}};
        validate_hexbinary_enumeration(&instance->idle_df[i], 1, enums_idle_df, "idle_df", &ustate->pu);
        if (ustate->pu.error) return;
    }
}

static size_t
array_idle_df_spp_pkt_t_spp_pkt__getArraySize(const spp_pkt_ *instance)
{
if (instance->prim_hdr.apid == 2047) {
    return(1);
} else {
    return(0);
}
...
static void
array_octet_udf_t_other_df_spp_pkt_t__initERD(other_df_spp_pkt_t_ *instance, InfosetBase *parent)
{
    UNUSED(parent);
    for (size_t i = 0; i < 65536; i++)
    {
...
static void
array_octet_udf_t_other_df_spp_pkt_t__parseSelf(other_df_spp_pkt_t_ *instance, PState *pstate)
{
    const size_t arraySize = array_octet_udf_t_other_df_spp_pkt_t__getArraySize(instance);
    validate_array_bounds("array_octet_udf_t_other_df_spp_pkt_t_", arraySize, 0, 65536, &pstate->pu);
    if (pstate->pu.error) return;
...
static void
array_octet_udf_t_other_df_spp_pkt_t__unparseSelf(const other_df_spp_pkt_t_ *instance, UState *ustate)
{
    const size_t arraySize = array_octet_udf_t_other_df_spp_pkt_t__getArraySize(instance);
    validate_array_bounds("array_octet_udf_t_other_df_spp_pkt_t_", arraySize, 0, 65536, &ustate->pu);
    if (ustate->pu.error) return;
...
static size_t
array_octet_udf_t_other_df_spp_pkt_t__getArraySize(const other_df_spp_pkt_t_ *instance)
{
    UNUSED(instance);
    return ((spp_pkt_ *)instance->_base.parent)->prim_hdr.len;
}
...
static void
other_df_spp_pkt_t__initERD(other_df_spp_pkt_t_ *instance, InfosetBase *parent)
{
    instance->_base.erd = &other_df_spp_pkt_t_ERD;
    instance->_base.parent = parent;
    array_octet_udf_t_other_df_spp_pkt_t__initERD(instance, parent);
}

static void
other_df_spp_pkt_t__parseSelf(other_df_spp_pkt_t_ *instance, PState *pstate)
{
    array_octet_udf_t_other_df_spp_pkt_t__parseSelf(instance, pstate);
    if (pstate->pu.error) return;
}

static void
other_df_spp_pkt_t__unparseSelf(const other_df_spp_pkt_t_ *instance, UState *ustate)
{
    array_octet_udf_t_other_df_spp_pkt_t__unparseSelf(instance, ustate);
    if (ustate->pu.error) return;
}

static void
array_other_df_spp_pkt_t_spp_pkt__initERD(spp_pkt_ *instance, InfosetBase *parent)
{
    UNUSED(parent);
    for (size_t i = 0; i < 1; i++)
    {
        other_df_spp_pkt_t__initERD(&instance->other_df[i], (InfosetBase *)instance);
    }
}

static void
array_other_df_spp_pkt_t_spp_pkt__parseSelf(spp_pkt_ *instance, PState *pstate)
{
    const size_t arraySize = array_other_df_spp_pkt_t_spp_pkt__getArraySize(instance);
    validate_array_bounds("array_other_df_spp_pkt_t_spp_pkt_", arraySize, 0, 1, &pstate->pu);
    if (pstate->pu.error) return;

    for (size_t i = 0; i < arraySize; i++)
    {
        other_df_spp_pkt_t__parseSelf(&instance->other_df[i], pstate);
        if (pstate->pu.error) return;
    }
}

static void
array_other_df_spp_pkt_t_spp_pkt__unparseSelf(const spp_pkt_ *instance, UState *ustate)
{
    const size_t arraySize = array_other_df_spp_pkt_t_spp_pkt__getArraySize(instance);
    validate_array_bounds("array_other_df_spp_pkt_t_spp_pkt_", arraySize, 0, 1, &ustate->pu);
    if (ustate->pu.error) return;

    for (size_t i = 0; i < arraySize; i++)
    {
        other_df_spp_pkt_t__unparseSelf(&instance->other_df[i], ustate);
        if (ustate->pu.error) return;
    }
}

static size_t
array_other_df_spp_pkt_t_spp_pkt__getArraySize(const spp_pkt_ *instance)
{
if (instance->prim_hdr.apid == 2047) {
    return(0);
} else {
...
spp_pkt__initERD(spp_pkt_ *instance, InfosetBase *parent)
{
    ...
    array_idle_df_spp_pkt_t_spp_pkt__initERD(instance, parent);
    array_other_df_spp_pkt_t_spp_pkt__initERD(instance, parent);
}
...
spp_pkt__parseSelf(spp_pkt_ *instance, PState *pstate)
{
    ...
    if (pstate->pu.error) return;
    array_idle_df_spp_pkt_t_spp_pkt__parseSelf(instance, pstate);
    if (pstate->pu.error) return;
    array_other_df_spp_pkt_t_spp_pkt__parseSelf(instance, pstate);
    if (pstate->pu.error) return;
}
...
spp_pkt__unparseSelf(const spp_pkt_ *instance, UState *ustate)
{
    ...
    if (ustate->pu.error) return;
    array_idle_df_spp_pkt_t_spp_pkt__unparseSelf(instance, ustate);
    if (ustate->pu.error) return;
    array_other_df_spp_pkt_t_spp_pkt__unparseSelf(instance, ustate);
    if (ustate->pu.error) return;
}
